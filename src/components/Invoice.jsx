...
const Invoice = forwardRef((props, ref) => {
  const { customerFirstName, customerLastName, customerEmail, customerPhone, reservationID, pickupDate, returnDate, selectedVehicle, selectedVehicleType } =
    ...
    <div className="hidden" ref={ref}>
      <div className="row p-5">
        <div className="col-6">
          <div className="row">
            ...
            <div className="row">
              ...
              <div>Unit : {selectedVehicle} {selectedVehicleType}</div>
              <div>Make and Model : {selectedVehicle} {selectedVehicleType}</div>
        ...
        <div className="col-6">
          ...
          <div>CLAIM:</div>
          <div>Date/Time Out: {returnDate} </div>
          <div className="mb-3">Date/Time In: {pickupDate}</div>
          <ChangesSummery />
